/* The video explains that 1000 as u8 would equal a value of 232. This is because u8 accepts
    ...
    defined value to adhere to the rules of the type that it is forced into. So 1000 - 256
    = 744, still too big. 744-256=488, still too big. 488-256 = 232, this is okay as u8.
